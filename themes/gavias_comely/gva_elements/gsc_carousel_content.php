      ...
      public function render_form(){
         ...
         for($i=1; $i<=8; $i++){
            ...
            $fields['fields'][] = array(
               ...
               'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="'.base_path().drupal_get_path('theme', 'gavias_comely').'/demo-font/index.html'.'">Custom icon</a>'),
            );
            $fields['fields'][] = array(
               'id'        => "title_{$i}",
               'type'      => 'text',
